...
file_write_mode= open("progression_file.txt","w") #opening the progression_file.txt under the write mode
...
while multiple_student == "y" or multiple_student=="Y":
    ...
    file_write_mode.write(progress_text) #writing the progress_text in progression_file.txt
    
    print("Would you like to enter another set of data?")
    multiple_student= continuation_string_validate()
    print("\n")

file_write_mode.close() #closing progression_file.txt
...
file_read_mode=open("progression_file.txt","r") #openinig the progression_file.txt in read mode
print(file_read_mode.read()) #printing the content in progression_file.txt
